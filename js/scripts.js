...
$(function(){
    ...
    function search(page,perPage,total,searchKeyword){
    ...
    $.get(API_URL, {
        ...
        $('.total').html('총 '+total+'개의 패스트푸드점이 검색되었습니다.');
...
function showPaging(page,perPage,total,searchKeyword){
    ...
    var $nextElem = $('<a href="javacript:search('+nextPage+','+perPage+ + ',\''+ searchKeyword+'\')">다음</a>');
